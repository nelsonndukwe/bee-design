  ...
  return (
    <body>
      ...
      >
        <div className="">
          <div
            className="text-[#d1ff48] font w-full text-[24rem] font-poppins font-bold text-center relative "
      ...
      <div ref={section2} className="section" id="section2">
      ...
      <div ref={section3} className="section" id="section3">
        <div className="flex px-10 items-center justify-between w-full">
          ...
          <div className="w-[600px] mr-[18%]">
            <p className=" text-[#F3FEB8] font-semibold text-6xl font-poppins ">
              ...
              stingers. Only female bees (the workers and the queen) can sting,
              and they usually only do it in defense.
            </p>
          </div>
        </div>
      </div>
      ...
      <div
        ref={section4}
        className="relative bg-transparent section "
        id="section4"
      >
      ...
      <div ref={section5} className="section" id="section5">
        <div className="flex justify-between items-center relative">
          ...
          <div className="basis-1/3 self-center mr-16">
            <p className="text-[#F3FEB8] font-bold text-5xl font-poppins ">
              ...
              pollinators, like bees, for reproduction. This includes about 35%
              of global food crops.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col gap-y-5 ">
          <p className="font text-5xl font-boldtext-[#F3FEB8]">Nelson Ndukwe</p>
